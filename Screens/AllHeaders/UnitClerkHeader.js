...
export default class UnitClerkHeader extends Component {
  render(){
    return (
      ...
      <Text style={{color: 'black',lineHeight: 20, alignSelf: 'flex-start',fontFamily:"Montserrat-SemiBold"}}>{Clerkinfo.UnitClerk}{'\n'}{Clerkinfo.Age}</Text>
...
<View style = {{flexDirection: 'row', width: '50%',justifyContent: 'flex-end',alignSelf:'flex-start'}}>
      <Text style={{lineHeight: 20, color: 'black',alignSelf:'flex-end',fontFamily:"Montserrat-Regular"}}>Location : {"\n"}Date: </Text>
        <Text style={{color: 'black',lineHeight: 20, alignSelf: 'flex-start',fontFamily:"Montserrat-SemiBold"}}>{Clerkinfo.Location}{'\n'}{Clerkinfo.Date}</Text>
      </View>
    </View>
    </View>
    );
